...
bool Fixed::operator>(const Fixed& rightVal) const {
    return fixedPointNum_ > rightVal.fixedPointNum_;
}
...
Fixed Fixed::operator+(const Fixed& rightVal) const {
    Fixed result;
    result.setRawBits(fixedPointNum_ + rightVal.getRawBits());
    return result;
}
...
Fixed Fixed::operator*(const Fixed& rightVal) const {
    Fixed result;
    result.setRawBits((fixedPointNum_ * rightVal.getRawBits()) >> fractionalBits_);
    return result;
}

Fixed Fixed::operator/(const Fixed& rightVal) const {
    Fixed result;
    result.setRawBits((fixedPointNum_ << fractionalBits_) / rightVal.getRawBits());
    return result;
}
...
Fixed Fixed::operator++(int) {
    Fixed tmp(static_cast<const Fixed&>(*this));
    fixedPointNum_ += 1;
    return tmp;
}
